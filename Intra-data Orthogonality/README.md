...
## Overview
The experimental codes for the Intra-data Orthogonality 


## Environment
- [PyTorch >= 1.7](https://pytorch.org/) **(Recommend **NOT** using torch 1.8!!! It would cause abnormal performance.)**
- [BasicSR == 1.3.4.9](https://github.com/XPixelGroup/BasicSR/blob/master/INSTALL.md) 
### Installation metrics in  
Install Pytorch first.
Install the [Quaternion Network](https://github.com/caoql98/Pytorch-Quaternion-Neural-Networks) 
Then,
```
...
- Preparation of training fluid dynamics data can refer to the paper.
- ImageNet dataset can be downloaded at the [official website](https://image-net.org/challenges/LSVRC/2012/2012-downloads.php).
